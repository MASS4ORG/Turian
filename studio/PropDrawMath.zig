...
// ─── Axis colour palette ──────────────────────────────────────────────────────
pub const col_x = dvui.Color{ .r = 210, .g = 60, .b = 60 };
pub const col_y = dvui.Color{ .r = 60, .g = 180, .b = 60 };
pub const col_z = dvui.Color{ .r = 60, .g = 100, .b = 210 };
pub const col_w = dvui.Color{ .r = 180, .g = 100, .b = 210 };
